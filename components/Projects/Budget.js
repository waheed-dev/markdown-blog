...
const Budget = () => {
    return (
        <Box  mt={'20'} display={['block','flex','flex','flex']} justifyContent={'space-evenly'} pb={'6'} borderBottom={['1px','0px','0px','0px']} borderColor={'green.600'} flexDirection={'row-reverse'} gap={'4'}>
            <Image
                src="/Budget.svg"
            ...
            <Box width={['','md','lg','lg']}>
                ...
                <Box display={'flex'} gap={'12'}>
                    ...
                    <Button colorScheme={'green'} bgColor={'green.600'}>Live preview</Button>
