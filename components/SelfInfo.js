...
const SelfInfo = () => {
    return (
        <Box mt={'20'}  mb={'10'} display={['block','flex','flex','flex']} justifyContent={'space-between'}>
            <Box gap={4} fontSize={'3xl'} fontWeight={'extrabold'} width={'lg'}>
                ...
                <Text fontSize={'xl'} fontWeight={'normal'}>
                   Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam et eveniet iusto nemo recusandae. Aut ex explicabo illum laborum mollitia odit officia, pariatur perspiciatis possimus quo, reiciendis sit vel veritatis!
                </Text>
